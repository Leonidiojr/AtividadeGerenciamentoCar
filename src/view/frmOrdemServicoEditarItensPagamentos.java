 ...
 * @author leoni
 */
public class frmOrdemServicoEditarItensPagamentos extends javax.swing.JFrame {

    /**
     * Creates new form frm
     */
    public frmOrdemServicoEditarItensPagamentos() {
        initComponents();        
     ...
     private void carregarOrdemServicoAtivo() {
       ...
       carregarDadosPagamentos(ordemServicoAtiva);

         try {
            BigDecimal somaPecas = ordemServicoController.somarPagamentosPorOrdemServico(ordemServicoAtiva.getId());
    ...
    // Método para carregar os dados de pagamentos no JTable1
    private void carregarDadosPagamentos(OrdemServico ordemServicoAtivaP) {
        ...
        try {
            ...
            // Obtém a lista de pagamentos associados à ordem de serviço ativa
            List<Pagamento> pagamentos = pagamentoController.buscarPagamentosPorOrdemServico(ordemServicoAtivaP.getId());

            for (Pagamento pagamento : pagamentos) {
                // Cria a linha de dados para a tabela
                Object[] linha = new Object[7];
                linha[0] = pagamento.getIdPagamento();
                linha[1] = pagamento.getDataPagamento().toString();
                linha[2] = pagamento.getNumeroOrdemServico();
                linha[3] = currencyFormatter.format(pagamento.getValorPago());
                linha[4] = pagamento.getTipoPagamento();
                linha[5] = currencyFormatter.format(pagamento.getDeslocamento());
                linha[6] = currencyFormatter.format(pagamento.getServicoGuincho());
            ...
            JOptionPane.showMessageDialog(null,
                    "Erro ao adicionar pagamentos na tabela:\n" + e.getMessage(),
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pagamento", "Data Pagamento", "Número OS", "Valor Pago", "Tipo Pagamento", "Deslocamento", "Serviço Guincho"
            }
        ) {
        ...
        jLabel2.setText("Lista de Pagamentos");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel3.setText("Total Pagamentos:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmOrdemServicoEditarItensPagamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmOrdemServicoEditarItensPagamentos().setVisible(true);
            }
        });
