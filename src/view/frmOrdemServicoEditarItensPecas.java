...
import model.AdicionarItemDialog;

/**
 *
 * @author leoni
 */
public class frmOrdemServicoEditarItensPecas extends javax.swing.JFrame {

    /**
     * Creates new form frm
     */
    public frmOrdemServicoEditarItensPecas() {
        initComponents();        
     ...
     private void carregarOrdemServicoAtivo() {
       ...
       try {
           ...
           /*
           Cliente cliente = ordemServicoController.obterClientePorDataEId(ordemServicoAtiva.getId(), ordemServicoAtiva.getData());
           if (cliente != null) {
               this.jTextField5.setText(cliente.getNomeCompleto());
               clienteAtivo = cliente;
           } else {
               this.jTextField5.setText("Cliente não encontrado");
           }
           this.jTextField5.setText(cliente.getNomeCompleto());           */
           
           try {
                BigDecimal somaPecas = ordemServicoController.somarPecasPorOrdemServico(ordemServicoAtiva.getId());
       ...
       carregarDadosItensPecas(ordemServicoAtiva);
              

}


    // Método para carregar os dados de ItensPecas no JTable1
    private void carregarDadosItensPecas(OrdemServico ordemServicoAtivaP) {
        ...
        try {
            ...
            // Obtém a lista de itens de peças associados à ordem de serviço ativa
            List<ItensPecas> itensPecas = itensPecasController.buscarItensPecasPorOrdemServico(ordemServicoAtivaP.getId());
        
            for (ItensPecas itemPeca : itensPecas) {
                // Cria a linha de dados para a tabela
                Object[] linha = new Object[6];
                linha[0] = itemPeca.getIdItensPK();
                linha[1] = itemPeca.getDescricao();
                linha[2] = itemPeca.getCodFabricante();
                linha[3] = itemPeca.getQntd();
                linha[4] = currencyFormatter.format(itemPeca.getPrecoUnit());
                linha[5] = currencyFormatter.format(itemPeca.getPrecoTotal());
            ...
            JOptionPane.showMessageDialog(null,
                    "Erro ao adicionar itens de peças na tabela:\n" + e.getMessage(),
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Item", "Descrição", "Código Fabricante", "Quantidade", "Preço Unitário", "Preço Total"
            }
        ) {
        ...
        jLabel3.setText("Lista de Pecas");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Exemplo de instanciamento e exibição da caixa de diálogo
        OrdemServicoController ordemServicoController = new OrdemServicoController();
        JFrame frame = new JFrame();
        AdicionarItemDialog dialog = new AdicionarItemDialog(frame, ordemServicoController);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmOrdemServicoEditarItensPecas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmOrdemServicoEditarItensPecas().setVisible(true);
            }
        });
