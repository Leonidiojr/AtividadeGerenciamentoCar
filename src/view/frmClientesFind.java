 ...
 * @author leoni
 */
public class frmClientesFind extends javax.swing.JDialog {

    /**
     * Creates new form frmFind
     */
    public frmClientesFind(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void carregarClientes() {
    ...
    SwingWorker<Void, Integer> worker = new SwingWorker<Void, Integer>() {
        ...
        protected Void doInBackground() throws Exception {
            ...
            ListaClientes = clienteController.pesquisarClientes(jTextField1.getText());
            jProgressBar1.setMinimum(0);
            jProgressBar1.setMaximum(ListaClientes.size());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (this.jButton1.isEnabled()) {
            clienteAtivo = new Cliente(ListaClientes.size()+1, "", "", "", "", "", "", "", "", "", "", 1, "", null, " " , "", "", "", "", "", "");            
        } else {
            redefineForm();
            jButton1.setEnabled(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmClientesFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmClientesFind dialog = new frmClientesFind(new javax.swing.JFrame(), true);
