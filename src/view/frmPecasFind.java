 ...
 * @author leoni
 */
public class frmPecasFind extends javax.swing.JDialog {

    /**
     * Creates new form frmFind
     */
    public frmPecasFind(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void carregarPecas() {
    ...
    SwingWorker<Void, Integer> worker = new SwingWorker<Void, Integer>() {
        ...
        protected Void doInBackground() throws Exception {
            ...
            // Lista os pecas ativos
            ListaPecas = pecaController.pesquisarPecas(jTextField1.getText());
            jProgressBar1.setMinimum(0);
            jProgressBar1.setMaximum(ListaPecas.size());

            // Verifica se a lista de pecas não está vazia
            ...
            // Adiciona os dados de cada peca na tabela
           for (int i = 0; i < ListaPecas.size(); i++) {
               // Preenche os dados do peca na tabela
               publish(i); // Publica o progresso
               String[] coluna = new String[5];
               coluna[0] = String.valueOf(ListaPecas.get(i).getIdPecasPK());
               coluna[1] = ListaPecas.get(i).getDescricao();
               coluna[2] = ListaPecas.get(i).getCodFabricante();
               coluna[3] = String.valueOf(ListaPecas.get(i).getQntdEstoque());
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nome", "Fabricante", "Estoque"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (this.jButton1.isEnabled()) {
            pecaAtivo = new Peca(0,"","", 0, new BigDecimal(0.0),0);
        } else {
            redefineForm();
            jButton1.setEnabled(true);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (selectedRow != -1) { // Verifica se uma linha foi selecionada
            try {
                ...
                String idPecaAtivo = value.toString();

                if (idPecaAtivo != null) {
                    // Realiza a busca pelo peca ativo
                    pecaAtivo = pecaController.buscarPeca(Integer.valueOf(idPecaAtivo));                    
                    this.dispose();
                    
                    // Exibe o valor do ID do peca
                    System.out.println("ID Peca Ativo: " + idPecaAtivo);

                } else {
                    System.out.println("Valor do ID do peca é nulo.");
                }
                ...
                System.out.println("Valor do ID do peca inválido: " + e.getMessage());
                e.printStackTrace();
            } catch (Exception e) {
                // Trata possíveis exceções ao buscar peca e abrir a janela
                System.out.println("Erro ao buscar peca ou abrir a janela: " + e.getMessage());
                e.printStackTrace();
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPecasFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPecasFind dialog = new frmPecasFind(new javax.swing.JFrame(), true);
