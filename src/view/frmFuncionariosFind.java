 ...
 * @author leoni
 */
public class frmFuncionariosFind extends javax.swing.JDialog {

    /**
     * Creates new form frmFind
     */
    public frmFuncionariosFind(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void carregarFuncionarios() {
    ...
    SwingWorker<Void, Integer> worker = new SwingWorker<Void, Integer>() {
        ...
        protected Void doInBackground() throws Exception {
            ...
            ListaFuncionarios = funcionarioController.pesquisarFuncionarios(jTextField1.getText());
            jProgressBar1.setMinimum(0);
            jProgressBar1.setMaximum(ListaFuncionarios.size());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (this.jButton1.isEnabled()) {
            funcionarioAtivo = new Funcionario("", "", "", 0);            
        } else {
            redefineForm();
            jButton1.setEnabled(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmFuncionariosFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmFuncionariosFind dialog = new frmFuncionariosFind(new javax.swing.JFrame(), true);
